...
class GUI:
    ...
    def layout(self,name):
        ...
        self.entryMsg.place(relwidth = 0.24,relheight=0.06,rely = 0.008,relyx = 0.011)
        self.entryMsg.focus()
        self.buttonMsg = Button(self.labelBottom, text = "send", font = "Helvetica 10 bold", width = 20, bg = "#abb289", command=lambda:self.sendButton(self.entryMsg.get()))
        self.buttonMsg.place(relx = 0.77,rely = 0.008,relheight=0.06,relwidth = 0.0)
